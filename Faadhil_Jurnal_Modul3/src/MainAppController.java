...
public class MainAppController {
    ...
    private void addTask() {
        try {
            ...
            if (dueDatePicker.getValue().isBefore(LocalDate.now())) {
                ...
                throw new InvalidDateException("Tanggal yang dimasukkan adalah tanggal masa lalu");
    ...
    private void deleteTask() {
        try {
            ...
            if (selected == null) {
                ...
                throw new TaskNotSelectedException("Sudah ada task yang dipilih?");
            }
    ...
    private void markTaskComplete() {
        try {
            ...
            if (selected == null) {
                // TODO: Throw new TaskNotSelectedException dengan pesan yang sesuai 
                throw new TaskNotSelectedException("Pilih task");
